...
public class ElderFormService {
     ...
     */
    /**
     * Начать создание новой заявки (с офертой в начале)
     */
    public UniversalResponse startNewRequest(Long userId) {
        ...
        tempElder.setConsentGiven(false);  // Пока не дано
        ...
        3. Я даю своё согласие на получение:
           • телефонных звонков от операторов пансионатов;
           • SMS-сообщений с предложениями;
           • сообщений в мессенджерах (MAX, Telegram) от операторов;
           • информационных рассылок о новых пансионатах и акциях.
